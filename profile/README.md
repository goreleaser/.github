...
### Latest releases
- GoReleaser [v1.15.1](https://github.com/goreleaser/goreleaser/releases/tag/v1.15.1) ([OSS](https://github.com/goreleaser/goreleaser), _released 5 days ago_)
- GoReleaser [v1.15.1-pro](https://github.com/goreleaser/goreleaser-pro/releases/tag/v1.15.1-pro) ([PRO](https://goreleaser.com/pro), _released 5 days ago_)
- GoReleaser [nightly](https://github.com/goreleaser/goreleaser-pro/releases/tag/nightly) ([PRO](https://goreleaser.com/pro))
- nFPM [v2.25.1](https://github.com/goreleaser/nfpm/releases/tag/v2.25.1) ([OSS](https://nfpm.goreleaser.com), _released 2 days ago_)
...
- GoReleaser Cross [v1.19.5](https://github.com/goreleaser/goreleaser-cross/releases/tag/v1.19.5) ([OSS](https://github.com/goreleaser/goreleaser-cross), _released 2 days ago_)
...
- [Releasing multi-platform container images with GoReleaser in Azure DevOps](https://blog.goreleaser.com/releasing-multi-platform-container-images-with-goreleaser-in-azure-devops-d8916df4250a?source=rss----17aa0cbd263f---4) (4 weeks ago)
