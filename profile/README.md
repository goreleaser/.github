...
- nFPM [v2.24.0](https://github.com/goreleaser/nfpm/releases/tag/v2.24.0) ([OSS](https://nfpm.goreleaser.com), _released 5 days ago_)
- GitHub Action for GoReleaser [v4.1.1](https://github.com/goreleaser/goreleaser-action/releases/tag/v4.1.1) ([OSS](https://github.com/goreleaser/goreleaser-action), _released 1 day ago_)
